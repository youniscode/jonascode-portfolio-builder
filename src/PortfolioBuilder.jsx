...
const DEFAULT_FORM = {
  ...
  projects: "", // initialise for controlled textarea
};

function getInitialState() {
  if (typeof window === "undefined") {
    return { form: DEFAULT_FORM, theme: "dark" };
  }
...
export default function PortfolioBuilder() {
  ...
  const [lastSavedAt, setLastSavedAt] = useState(null); // track last auto-save time
  const autosaveTimer = useRef(null); // debounced autosave timer
  ...
  // Set standalone page title
  useEffect(() => {
    document.title = "Portfolio Builder – JonasCode";
  }, []);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        {/* Skills & Projects under the main container */}
